            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <StatCard
                  ...
                  value={liveData.congestionLevel}
                  unit="%"
                  trend={8}
                ...
                <StatCard
                  ...
                  value={liveData.incidentCount.toFixed(0)}
                  unit=""
                  trend={-25}
                ...
                {[
                  ...
                  <div key={idx}>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                      <div 
                        className={`h-3 bg-gradient-to-r from-${zone.color}-400 to-${zone.color}-600 rounded-full transition-all duration-500 ease-out`}
                        style={{ width: `${zone.flow}%` }}
                      ></div>
                    </div>
                  </div>
                ))}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="text-sm font-bold text-gray-800">91.8%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="bg-gradient-to-r from-blue-400 to-indigo-500 h-2 rounded-full" style={{ width: '91.8%' }}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-sm text-gray-600">Response Time</span>
                      <span className="text-sm font-bold text-gray-800">0.3s</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="bg-gradient-to-r from-purple-400 to-pink-500 h-2 rounded-full" style={{ width: '97%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-500">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          {incident.affected} vehicles affected
                        </span>
                      </div>
                    </div>
